...
## 2.1. Animal recognition - trains a Convolutional Neural Network to decide what animal is on the picture.
...
## 3.2. IntentRecognitionAirlines - classification task - to understand user's intent and generate respective response.
...
## 3.3. IntentRecognitionChatbot - chatbot that undestands user's intent from natural language query and responses with predefined answers.
...
## 3.6. Dialog-based chatbot - encoder-decoder structure Neural Network for chatbot.
### Size: Medium (473 lines).
...
## 4.1. House price - predict  the price of a house given its features.
...
## 5.1. AirlinePassengers - predict the number of arline passengers usingSARIMAX or LSTM approaches.
### Size: Large (1435 lines).
https://github.com/sersonSerson/Projects/tree/master/TimeSeries/AirlinePassengers
